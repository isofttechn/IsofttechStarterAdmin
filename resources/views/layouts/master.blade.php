    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-primary navbar-badge"><i class="fa fa-bell fa-3x mr-2" aria-hidden="true"></i></span>
        </a>
  ...
  <!-- Hide from users -->
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-cog fa-spin fa-3x fa-fw green" aria-hidden="true"></i>
              <p>
                Setting
